...
const Discover: React.FC = () => {
  ...
  return <div className="flex flex-col h-screen bg-gradient-to-b from-island-dark via-island to-island-dark">
      <div className="container mx-auto px-4 py-8 my-[73px]">
        <h1 className="text-3xl font-bold text-center text-white mb-6">Discover People</h1>

        {/* Profile display component */}
        <ProfileDisplay profile={currentProfile} isLoading={isLoading} onSwipe={handleSwipe} onOpenFilters={openFilterDialog} filterCount={countActiveFilters()} />

        {/* Filters component */}
        <DiscoverFilters activeFilters={filters} onFilterChange={setFilters} isOpen={isFilterDialogOpen} onOpenChange={setIsFilterDialogOpen} />
