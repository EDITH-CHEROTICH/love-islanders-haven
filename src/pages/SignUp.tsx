    ...
    <div className="min-h-screen bg-gradient-to-b from-island-dark via-island to-island-dark pt-4 pb-20 flex flex-col items-center justify-center px-4">
      <div className="glass-card w-full max-w-md p-6 rounded-xl shadow-lg">
        <h1 className="text-2xl font-bold text-gradient text-center mb-6">
          {isLoginMode ? "Welcome Back" : "Join Love Islanders"}
        </h1>
        
        <Button 
          onClick={handleGoogleSignIn}
          className="w-full bg-white text-black hover:bg-gray-100 mb-4 flex items-center justify-center gap-2"
          disabled={isLoading}
        >
        ...
        <Tabs defaultValue="email" className="w-full">
          ...
          <TabsContent value="email">
            <form onSubmit={handleEmailSignUp} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full bg-love hover:bg-love-dark flex items-center gap-2"
                disabled={isLoading}
              >
                {isLoading ? (
                  "Processing..."
        ...
        <div className="mt-6 text-center">
          <p className="text-muted-foreground">
            ...
            <button
              ...
              className="text-love hover:underline font-medium"
            >
